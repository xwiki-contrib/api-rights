 ...
 *
 * @version $Id: b8adacfb1a523598897c9c6483709f1ba490231b $
 * @since 4.0M2
 */
@Unstable
@Component
...
public class DefaultSecurityEntryReader implements SecurityEntryReader
{
     ...
     *
     * @param entity Any entity reference that is either a WIKI or a SPACE, or an entity containing a DOCUMENT
     *     entity.
        ...
        throws AuthorizationException
    {
        ...
        if (owner != null) {
            ...
            if (context.isMainWiki(documentWiki.getName())) {
                ...
                rules.add(
                    new XWikiSecurityRule(OWNER_RIGHTS, RuleState.ALLOW, Collections.singleton(owner), null));
            }
        }
    }

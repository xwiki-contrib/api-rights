        ...
        throws XWikiException, UnsupportedOperationException
    {
        ...
        if (reference != null && !CollectionUtils.isEmpty(rules)) {
            ...
            switch (reference.getType()) {
                case WIKI:
                    rightsStorageDocReference = new DocumentReference(XWIKI_PREFERENCES,
                    ...
                    break;
                case SPACE:
                    rightsStorageDocReference =
                        new DocumentReference(XWIKI_WEB_PREFERENCES, new SpaceReference(reference));
                    rightsClassReference = XWIKI_GLOBAL_RIGHTS_CLASS;
                    storageDocIsPrefsDoc = true;
                    break;
                case DOCUMENT:
